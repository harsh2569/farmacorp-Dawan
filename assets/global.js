  ...
  setSlideVisibility() {
    this.sliderItemsToShow.forEach((item, index) => {
      ...
      if (index === this.currentPage - 1) {
        ...
        console.log(item.getAttribute('data-scheme'));
        this.prevButton.style.color = item.getAttribute('data-scheme');
        this.nextButton.style.color = item.getAttribute('data-scheme');
      } else {
...
// Custom js for button color change on click

// $(".banner--large .button--tertiary").click(function(evt){
//     evt.preventDefault();
//   $(".button--tertiary").toggleClass("clicked");
// });

// $(".banner--large .button--primary").click(function(evt){
//     evt.preventDefault();
//   $(".button--primary").toggleClass("clicked");
// });
 
$('.footer-block--menu .footer-block__heading').on('click', function(event){
  if($(window).width() < 767) {
console.log('clicked heading footer Ios');
event.preventDefault();
...
accordion.siblings('ul').slideToggle();
...
$(document).ready(function(){
  $('.footer_filter a.remove_all').on('click', function(){
      console.log('clicked');
      $(".store-filters input").prop('checked', false); 
